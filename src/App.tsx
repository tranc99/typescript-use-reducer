    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-sm-8">
          ...
          <h2><small className="text-muted">Welcome to The Crabby Fish.</small></h2>
          <div className="alert alert-info">
            <p className="lead"> Please select your entree below.</p>
          </div>
          <div className="input-group mb-3">
            <div className="input-group-prepend">
              <label className="input-group-text" htmlFor="inputGroupSelect01">Entrees</label>
            </div>
            <select onChange={(e) => dispatch({type: e.target.value})} className="custom-select" id="inputGroupSelect01">
              {menuOptions}
            </select>
          </div>
          ...
          <div>
            ...
            <div className="col-sm-8">
              ...
              <p className="h6"><em><strong>{state.selectedItem.description}</strong></em></p>
              <p className="h6">Price - {state.selectedItem.price}</p>
              <p className="h6">Ready in {state.selectedItem.waitTime}</p>
              <img src={state.selectedItem.imgURL} alt="your selection" className="img-thumbnail" />
            </div>
          </div>
        </div>
        <div className="col-sm">
